...
class TestRefactoredComponents:
    ...
    def test_refactored_method_signatures(self):
        ...
        # Test CoachAgent methods exist
        from backend.agents.coach import CoachAgent
        
        assert hasattr(CoachAgent, '_build_evaluation_inputs')
        assert hasattr(CoachAgent, '_extract_feedback_text')
        assert hasattr(CoachAgent, '_process_summary_response')
        assert hasattr(CoachAgent, '_build_summary_inputs')
        ...
        assert hasattr(AgentSessionManager, '_add_recommended_resources')
    ...
    def test_imports_work_correctly(self):
        ...
        from backend.agents import CoachAgent as ImportedCoach
        ...
        assert CoachAgent is ImportedCoach
    ...
    def test_circular_imports_resolved(self):
        ...
        try:
            ...
            from backend.agents import InterviewerAgent, CoachAgent, AgentSessionManager
            from backend.agents.constants import DEFAULT_JOB_ROLE
            from backend.utils.common import get_current_timestamp
    ...
    def test_refactoring_completeness(self):
        ...
        # Test that CoachAgent has new helper methods
        assert hasattr(CoachAgent, '_build_evaluation_inputs')
        assert hasattr(CoachAgent, '_extract_feedback_text')
